...
//                 context,
//                 MaterialPageRoute(
//                   builder: (context) => const ManufacturingListPage(),
//                 ),
//               );
//               return;
...
class _ManufacturingPageChildState extends State<ManufacturingPageChild> {
  ...
  void _searchForRawItem(int index) {
    ...
    context
        .read<InventoryBloc>()
        .add(SearchItems(search: _rawItemNameControllers[index].text, page: 1));
  }
                  ...
                  children: [
                            ...
                            children: [
                              Row(
                                children: [
                                  ...
                                  const SizedBox(width: 5),
                                  if (widget.mainModel?.serial != null) ...[
                                    Expanded(
                                      flex: 3,
                                      child: MyTextField(
                                        controller: _serialController,
                                        ...
                                        suffixIcon: state is InventoryLoading &&
                                                _isLoading
                                            ? const Padding(
                                                padding: EdgeInsets.all(10),
                                                child: SizedBox(
                      ...
                      child: _isLandscape
                          ? Row(
                              ...
                              children: [
                                Expanded(
                                  child: SingleChildScrollView(
                                    child: _buildFinishedItemsView(
                                        isLandscape: true),
                                  ),
                                ),
                                Expanded(
                                  child: SingleChildScrollView(
                                      child: _buildRawItemsView(
                                          isLandscape: true)),
                                ),
                              ],
                            )
                          : SingleChildScrollView(
                              child: Column(
                                children: [
                                  _buildFinishedItemsView(isLandscape: false),
                                  _buildRawItemsView(isLandscape: false),
                                ],
                              ),
                            ),
                    ),
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Mybutton(
                            text: widget.mainModel == null ? 'إضافة' : 'تعديل',
                            onPressed: _submitForm,
                          ),
                          if (widget.mainModel != null)
                            IconButton(
  ...
  // --- WIDGET FOR RAW MATERIALS LIST ---
  Widget _buildRawItemsView({required bool isLandscape}) {
          ...
          itemBuilder: (context, index) {
            return Card(
              ...
              child: Padding(
                padding: const EdgeInsets.all(12),
                child: isLandscape
                    ? _buildRawItemRowLandscape(index)
                    : _buildRawItemColumnPortrait(index),
              ),
            );
          },
        ),
  ...
  // --- WIDGET FOR FINISHED PRODUCTS LIST ---
  Widget _buildFinishedItemsView({required bool isLandscape}) {
    return ExpansionTile(
      title: const Text('مواد خارجة (منتجات نهائية)'),
      initiallyExpanded: true,
      children: [
          ...
          itemBuilder: (context, index) {
            return Card(
              ...
              child: Padding(
                padding: const EdgeInsets.all(12),
                child: isLandscape
                    ? _buildFinishedItemRowLandscape(index)
                    : _buildFinishedItemColumnPortrait(index),
              ),
            );
          },
        ),
  ...
  // --- PORTRAIT LAYOUT FOR RAW ITEM ---
  Widget _buildRawItemColumnPortrait(int index) {
    return Column(
      children: [
        Row(
          children: [
            ...
            Expanded(
              flex: 12,
              child: MyTextField(
                suffixIcon: _buildItemSuffixIcon(
                    index, true, _rawSelectedItemData[index]),
                controller: _rawItemNameControllers[index],
                labelText: 'المادة الخام',
                validator: (value) => (value == null || value.isEmpty)
                    ? 'الرجاء إدخال المادة'
                    : null,
                focusNode: _rawItemNameFocusNodes[index],
                onSubmitted: (value) => _searchForRawItem(index),
              ),
            ),
            if (_rawItems.length > 1)
              Expanded(
                ...
                child: IconButton(
                  ...
                  onPressed: () => _removeRawItem(index),
                ),
              ),
          ],
        ),
        ...
        Row(
          children: [
            Expanded(
              ...
              child: MyTextField(
                readOnly: true,
                controller: _rawItemUnitControllers[index],
                labelText: 'الوحدة',
              ),
            ),
            const SizedBox(width: 8),
            Expanded(
              flex: 1,
              child: MyTextField(
                controller: _rawQuantityControllers[index],
                focusNode: _rawQuantityFocusNodes[index],
                labelText: 'الكمية',
                keyboardType:
        ...
        const SizedBox(height: 10),
        MyTextField(
          controller: _rawItemNoteControllers[index],
          labelText: 'البيان',
          maxLines: 2,
        ),
        const SizedBox(height: 10),
        MyTextField(
          controller: _rawWarehouseControllers[index],
          labelText: 'المستودع',
          focusNode: _rawWarehouseFocusNodes[index],
          // Suffix icon logic can be added here if needed
        ),
      ],
    );
  }

  // --- LANDSCAPE LAYOUT FOR RAW ITEM ---
  Widget _buildRawItemRowLandscape(int index) {
    return Row(
      ...
      children: [
        ...
        Expanded(
          ...
          child: MyTextField(
            suffixIcon:
                _buildItemSuffixIcon(index, true, _rawSelectedItemData[index]),
            controller: _rawItemNameControllers[index],
            labelText: 'المادة الخام',
            validator: (value) =>
  ...
  // --- PORTRAIT LAYOUT FOR FINISHED ITEM ---
  Widget _buildFinishedItemColumnPortrait(int index) {
    return Column(
      children: [
        Row(
          children: [
            ...
            Expanded(
              ...
              child: MyTextField(
                suffixIcon: _buildItemSuffixIcon(
                    index, false, _finishedSelectedItemData[index]),
                controller: _finishedItemNameControllers[index],
                labelText: 'المنتج النهائي',
                validator: (value) => (value == null || value.isEmpty)
                    ? 'الرجاء إدخال المنتج'
                    : null,
                focusNode: _finishedItemNameFocusNodes[index],
                onSubmitted: (value) => _searchForFinishedItem(index),
              ),
            ),
            if (_finishedItems.length > 1)
              Expanded(
                ...
                child: IconButton(
                  icon: const Icon(Icons.remove_circle, color: Colors.red),
                  onPressed: () => _removeFinishedItem(index),
                ),
              ),
          ],
        ),
        ...
        Row(
          children: [
            Expanded(
              ...
              child: MyTextField(
                readOnly: true,
                controller: _finishedItemUnitControllers[index],
                labelText: 'الوحدة',
              ),
            ),
            const SizedBox(width: 8),
            Expanded(
              flex: 1,
              child: MyTextField(
                controller: _finishedQuantityControllers[index],
                focusNode: _finishedQuantityFocusNodes[index],
                labelText: 'الكمية',
                keyboardType:
                    const TextInputType.numberWithOptions(decimal: true),
                validator: (value) {
        ...
        const SizedBox(height: 10),
        MyTextField(
          controller: _finishedItemNoteControllers[index],
          labelText: 'البيان',
          maxLines: 2,
        ),
        const SizedBox(height: 10),
        MyTextField(
          controller: _finishedWarehouseControllers[index],
          labelText: 'المستودع',
          focusNode: _finishedWarehouseFocusNodes[index],
        ),
      ],
    );
  }

  // --- LANDSCAPE LAYOUT FOR FINISHED ITEM ---
  Widget _buildFinishedItemRowLandscape(int index) {
    return Row(
      crossAxisAlignment: CrossAxisAlignment.center,
      children: [
        Column(
  ...
  Widget _buildItemSuffixIcon(int index, bool isRaw, ItemsModel? selectedItem) {
    return SizedBox(
      width: 24,
      height: 24,
      child: _isSearchingItem &&
          ...
          : IconButton(
              ...
              constraints: const BoxConstraints(),
              tooltip: 'عرض التفاصيل',
              onPressed: () => _showItemDetailsDialog(selectedItem),
            ),
    );
  }
