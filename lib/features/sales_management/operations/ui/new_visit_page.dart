                        ...
                        return Column(
                          children: [
                            (_selectedCustomer == null &&
                                ...
                                // START: InkWell added for customer click functionality
                                : Column(
                                    children: [
                                      InkWell(
                                        onTap: () {
                                      ...
                                      // END: InkWell added for customer click functionality
                                      const SizedBox(
                                        height: 10,
                                      ),
                                      Row(
                            ...
                            BlocConsumer<SalesBloc, SalesState>(
                              listener: (context, state) {
                                ...
                                // START: Added navigation for full customer data
                                else if (state
                                    is SalesOpSuccess<CustomerViewModel>) {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) {
                                ...
                                // END: Added navigation for full customer data
                              },
                              builder: (context, state) {
